...
def get_metadata(dataset_name):
    if dataset_name == 'pascal':
        ...
        meta = {
            'num_classes': 81,
            'path_to_dataset': '/u/vul-d1/scratch/xxing/SPML/data/nuswide',
            'path_to_images': '/u/vul-d1/scratch/xxing/SPML/data/nuswide/Flickr'
        }
    elif dataset_name == 'cub':
        meta = {
            'num_classes': 312,
            'path_to_dataset': '/u/vul-d1/scratch/xxing/SPML/data/cub',
            'path_to_images': '/u/vul-d1/scratch/xxing/SPML/data/cub/CUB_200_2011/images'
        }
    else:
