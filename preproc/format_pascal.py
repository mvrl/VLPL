...
pp.add_argument('--load-path', type=str, default='/u/vul-d1/scratch/xxing/SPML/data/pascal', help='Path to a directory containing a copy of the PASCAL dataset.')
pp.add_argument('--save-path', type=str, default='/u/vul-d1/scratch/xxing/SPML/data/pascal', help='Path to output directory.')
args = pp.parse_args()
