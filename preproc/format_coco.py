...
pp.add_argument('--load-path', type=str, default='/u/vul-d1/scratch/xxing/SPML/data/coco', help='Path to a directory containing a copy of the COCO dataset.')
pp.add_argument('--save-path', type=str, default='/u/vul-d1/scratch/xxing/SPML/data/coco', help='Path to output directory.')
args = pp.parse_args()
